        ...
        <div className="container">
          ...
          <div id="navbarSupportedContent" className="collapse navbar-collapse">
            <ul className="navbar-nav ml-auto">
              <li className="nav-item"><a href="apts" className="nav-link">Apartments<span role="img" aria-labelledby="apartment">&#127972;</span></a></li>
              <li className="nav-item"><a href="houses" className="nav-link">Houses<span role="img" aria-labelledby="house">&#127960;</span></a></li>
              <li className="nav-item"><a href="layouts" className="nav-link">Layouts<span role="img" aria-labelledby="city">&#127961;</span></a></li>
            </ul>
          </div>
        </div>
      </nav>);
